...
const BorderedButton: React.FC<BorderedButtonType> = ({ children, onClick, ...rest }) => {
    return (
        <div className={classNames('md:h-14.5 size-[50px] md:w-14.5  rounded-[16px] !p-1.5 text-[#412B6C] !text-xs cursor-pointer bg-gradient-to-t from-[#02BAD4] to-[#A4E3F0]', rest.className)}>
